      ...
      <footer className="px-6 lg:px-8 py-12 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">Imaginary Sass</span>
              </div>
              <p className="text-gray-400 mb-4">
                AI-powered image generation and editing platform for creators
                and businesses.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Imaginary Sass. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
